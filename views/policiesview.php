    ...
    <body>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2"><i class="fas fa-user-secret"></i> Polítiques de seguretat</h1>
                <div class="btn-toolbar mb-2 mb-md-0">
                    <form name="form" action="index.php?controlador=Policies&action=New" method="post">
                        <button type="submit" name="submit" class="btn btn-sm btn-outline-primary">Nova</button>
                    </form>
                </div>
            </div> 
        ...
        <script type="text/javascript">
            function load(obj) { /* carrega el contingut de la paàgina */
                ...
                $.ajax({ /* recupera la llista de politiques i la paginació */
                    type: "GET",
                    url: "ajax/ajaxpolicieshandler.php",
                    dataType: 'json',
                    cache: false,
                    data: dataString,
