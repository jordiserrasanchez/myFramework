                ...
                <main role="main" class="col-md-8 ml-sm-auto col-lg-10 px-4">
                    <div class="col-md-8 order-md-1">
                        <div class="py-5 text-center">
                            <h1><i class="fas fa-directions"></i> Fitxa del tipus d'accés</h1>
                        </div>
                    </div>
                    ...
                    <div style="max-height: 820px; height: 820px; overflow-x: auto; overflow-y: auto; margin-top: -5px;">
                        ...
                        <div class="col-md-8 order-md-1">
                            <form action="index.php?controlador=AccessTypes&action=Save" method="post" class="needs-validation" novalidate>
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="codi">Codi</label>
                                        <input type="text" name="codi" class="form-control" id="codi"  placeholder="" value="<?php echo $this->tipusacces[ 'codi'] ?? ""; ?>" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="descripcio" class="form-control" id="descripcio"  placeholder="" value="<?php echo $this->tipusacces[ 'descripcio' ]  ?? ""; ?>" required>
                                        <div class="invalid-feedback">
                                ...
                                <button class="btn btn-danger" type="submit" formaction="index.php?controlador=AccessTypes&action=ViewList">Anul·lar</button>
                                <input type="text" name="idTipusAcces" id="idTipusAcces" value="<?php echo $this->tipusacces[ 'idTipusAcces' ]  ?? ""; ?>" hidden>
                             </form>
                        </div>
                    </div>
                </main>
