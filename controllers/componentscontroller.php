...
/**
 * Documentació de la classe componentscontroller.
 * @access public 
 ...
 * @package componentscontroller
 * @subpackage components
 * @version 1.0.0
 */
final class componentscontroller extends controller {
    ...
    private function viewList ( ) {
        ...
        $this->concepte = $this->model->getLlistaComponents ( );
        
        /** estableix la vista que s'ha de mostrar */
        $this->view = $_SESSION["viewPath"] . 'componentsview.php';        
    }
    ...
    private function editComponent ( ) {
        ...
        if ( filter_has_var ( INPUT_POST , 'idModificar' ) ) {  /** si s'ha sel·leccionat component */
            ...
            $this->modul = $modul->getAddonById ( $this->component['idModul'] );            
    ...
    private function insertComponent ( ) {
        ...
        $fields = "'" . $this->nomComponent . "',". $this->idModul;
